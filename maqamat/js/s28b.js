...
//1-ADD PAUSE ON AL HARITH
.set({}, {}, "+=9.20")

//2-PAN RIGHT ON AL HARITH
.to(pic1, 16.35, {
  scale: 1.0,
  xPercent: -48,
  yPercent: -9,
...
//CROSSFADE TO ANOTHER IMAGE FROM AL HARITH TO ABU ZAYD
.to(pic1, 1, {
  opacity:0,
  ease: Sine.easeInOut
})
...
//CROSSFADE TO ANOTHER IMAGE FROM ABU ZAYD TO FOLIO IMAGE
.to(pic2, 1, {
  opacity:0,
  ease: Sine.easeInOut
})
